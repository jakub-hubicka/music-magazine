<form enctype="multipart/form-data" action="../handlers/post.handler.php" method="post">
    ...
    <div class="form-group">
        <label>Text</label>
        <textarea require_onced id="summernote" style="height: 300px" class="form-control" name="content"></textarea>
    </div>
    ...
    <div class="form-group">
        <label>Vícedenní akce</label>
        <input type="checkbox" id="multiDayEvent">
    ...
    <div class="form-group">
        <label>Typ (koncert/festival)</label>
        <select name="eventType">
            <option value="Koncert" default>Koncert</option>
            <option value="Festival">Festival</option>
        </select>
    </div>
    <div class="form-group">
        <label>Začátek (čas)</label>
    ...
    <input type="hidden" name="type" value="akce">
