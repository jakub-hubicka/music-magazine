<form enctype="multipart/form-data" action="../handlers/post.handler.php" method="post">
    <div class="form-group">
        <label>Nadpis</label>
        <input require_onced type="text" class="form-control input-title" name="title">
    </div>
    <div class="form-group">
        <label>Intro</label>
        <input require_onced type="text" class="form-control input-intro" name="intro">
    </div>                                                 
    <div class="form-group">
        <label>Text</label>
        <textarea require_onced id="summernote" class="form-control" name="content"></textarea>
    </div>
    ...
    <div id="upload-main-preview" class="c-croppie__preview c-croppie__preview--main-news"></div>
    ...
    <div class="form-group">
        <label>Druhej volitelnej štítek</label>
        <input require_onced type="text" class="form-control input-small" name="optionalTag">
    </div>
    <div class="form-group">
        <label>Tagy</label>
